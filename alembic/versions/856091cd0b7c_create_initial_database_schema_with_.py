...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "average_covered_charges", sa.Numeric(precision=10, scale=2), nullable=False
        ),
        sa.Column(
            "average_total_payments", sa.Numeric(precision=10, scale=2), nullable=False
        ),
        sa.Column(
    ...
    op.create_index(
        "idx_drg_provider_definition",
        "drg_prices",
        ["provider_id", "ms_drg_definition"],
    )
